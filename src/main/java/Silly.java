...
public class Silly implements Comparable<Silly>{
    ...
    /**
     * Creates a new Silly object.
     * This constructor takes in two arguments of String.
     *
     * @param s1 the first string for this Silly instance's first part of name.
     * @param s2 the second String for this Silly instance's second part of name.
     */
